...
<section class="section-padding gray-bg">
  <div class="container">
    <div class="section-header text-center">
      ...
      <p>There are many Cars available with us. In order to rent a car, you will need to rent a car from our website. We will confirm the booking if it is available. We will reach out to you. You can then visit our service and take the car from us. Payment is done once the process is completed.</p>
    </div>
    <div class="row"> 
