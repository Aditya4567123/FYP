...
if(isset($_REQUEST['del']))
	{
$delid = $_GET['del'];
$delete = "DELETE from tblvehicles SET id=:status WHERE id=:delid";
$result = $dbh->prepare($delete);
$result->execute();
...
{				?>	
										<tr>
											...
											<td hidden><?php echo htmlentities($result->id);?></td>
...
<a href="Delete.php?id=<?php echo $result->id;?>" onclick="return confirm('Do you want to delete');"><i class="fa fa-close"></i></a></td>
										</tr>
										<?php $cnt=$cnt+1; }} ?>
